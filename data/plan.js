...
window.TRIP = {
  ...
  SEED: {
    ...
    d6: [['p:lafayette-grand-cafe', '10:00', 45], ['p:soho-shopping', '10:55', 130], ['p:balthazar', '13:15', 70], ['p:elizabeth-street-nolita', '14:35', 45], ['x:drop-bags', '16:05', 40], ['p:sofreh', '17:15', 60], ['x:teddy-swims', '19:00']],
  ...
  BOOK: [
    ...
    { id: 'sofreh', day: 'd6', by: '2026-09-25', en: 'Table for 2 at 5:20 pm on Fri Oct 2 — an early sitting, four minutes\' walk from Barclays before the 7 pm show. Sofreh books up; Resy opens 30 days out.', ru: 'Столик на двоих в 17:20 в пятницу 2 октября — ранняя посадка, в четырёх минутах пешком от Barclays перед шоу в 19:00. Sofreh быстро заполняется; Resy открывается за 30 дней.', de: 'Tisch für 2 um 17:20 Uhr am Freitag, 2. Oktober — frühe Sitzung, vier Gehminuten vom Barclays vor der Show um 19 Uhr. Sofreh ist schnell ausgebucht; Resy öffnet 30 Tage vorher.', de: 'Die späte Show am Freitag, 2. Oktober reservieren (die Reservierung öffnet etwa eine Woche vorher und ist schnell weg).' },
