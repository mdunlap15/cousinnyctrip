...
self.addEventListener('fetch', (e) => {
  ...
  if (['open-meteo.com', 'supabase.co', 'railway.app', 'openstreetmap.org', 'openstreetmap.fr', 'cartocdn.com', 'basemaps.cartocdn.com'].some((d) => url.hostname === d || url.hostname.endsWith('.' + d))) return;
